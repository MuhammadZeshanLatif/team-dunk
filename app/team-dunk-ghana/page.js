...
const pillars=[
  ['â—‰','Play','High-quality basketball training that builds skills, teamwork and a lifelong love of the game.'],
  ['â™¢','Lead','Leadership development that empowers youth to lead with confidence and integrity.'],
  ['â–¤','Grow','Academic support and life skills that open doors to opportunity and personal growth.'],
  ['â™§','Connect','Stronger communities built through mentorship, family engagement and shared purpose.']
];
...
export default function Ghana(){return <main className="ghana-redesign">
  ...
  <section className="gh-impact"><Image src="/images/ghana/redesign/clinic-impact.webp" alt="Coach leading a Team Dunk basketball clinic" fill sizes="100vw"/><div className="gh-impact-shade"/><div className="container gh-impact-content"><div><h2>BASKETBALL THAT<br/>BUILDS CONFIDENCE</h2><p>On the court, we teach more than basketball. We build courage, discipline and belief in whatâ€™s possible.</p></div><div className="gh-metrics"><article><b>500+</b><span>Youth<br/>Served</span></article><article><b>20+</b><span>Communities<br/>Impacted</span></article><article><b>15+</b><span>Coaches &<br/>Mentors</span></article><article><b>100%</b><span>Commitment<br/>to Growth</span></article></div></div></section>
