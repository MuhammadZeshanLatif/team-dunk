...
const experiences=[
  ...
  ['Music & Movement','Turn up original Dunkiverse music, learn the Dunkiverse Shuffle and move with the characters on and off the court.','/images/dunkiverse/music-movement-little-glow.png']
];
...
export default function Dunkiverse(){return <div className="dunkiverse-page">
  ...
  <section id="world" className="section"><div className="container split"><div className="dunkiverse-art"><Image src="/images/dunkiverse/dunkiverse-highlight-roblox-court.png" alt="Roblox Dunkiverse basketball court gameplay" fill sizes="(max-width: 800px) 100vw, 50vw"/></div><div><SectionTitle eyebrow="What is the Dunkiverse?" title="Watch. Play. Move. Discover."/><p>The Dunkiverse is an original entertainment universe where basketball, storytelling, music, gaming and adventure come together. Follow a growing cast of heroes through animated stories, original music and interactive experiences — then step inside their world on Roblox.</p><ul className="neon-list"><li>Watch original animated Dunkiverse stories</li><li>Meet Little Dunk, Glow Dunk, Hoopnaria, Turbo Dunk and more</li><li>Explore worlds, quests and basketball challenges on Roblox</li><li>Move to original music and the Dunkiverse Shuffle</li><li>Discover stories about confidence, teamwork, identity and finding your own power</li></ul></div></div></section>
